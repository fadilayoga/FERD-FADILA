...
import { Flex, Text, Checkbox, Heading, Input, Icon, Box, ScrollView, VStack, NativeBaseProvider } from "native-base"
    ...
    <ScrollView>
      <Flex align="center">
        <VStack space={2} w="100%">
          <Heading size="md" color="primary.300">Wishlist</Heading>
          <Input
            InputRightElement={
              <Icon
          ...
          {item.map((items, idx) => (
            ...
            >
              ...
              <MaterialCommunityIcons name="delete" size={24} color="black" onPress={() => onDelete(idx)} />
            </Flex>
          ))}
        </VStack>
      </Flex>
